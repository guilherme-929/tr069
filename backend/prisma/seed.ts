...
async function main() {
  ...
  const models = [
    ...
    { manufacturer: 'TP-Link', name: 'XC220-G3', hwVersion: 'v1.0', dataModel: 'TR-181', defaultParameters: { 'Device.ManagementServer.URL': 'http://acs.local:7547/cwmp', 'Device.ManagementServer.PeriodicInformInterval': '300', readOverrides: ['Device.WiFi.AccessPoint.{i}.Security.X_TP_PreSharedKey'] } },
    { manufacturer: 'TP-Link', name: 'XX530v', hwVersion: 'v1.0', dataModel: 'TR-181', defaultParameters: { 'Device.ManagementServer.URL': 'http://acs.local:7547/cwmp', 'Device.ManagementServer.PeriodicInformInterval': '300', readOverrides: ['Device.WiFi.AccessPoint.{i}.Security.X_TP_PreSharedKey'] } },
